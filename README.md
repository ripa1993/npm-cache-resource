I found this one that was only pushed to my github... It was/is used by Frankie... not sure if it is needed anymore given that all pages are being removed from our old friend  :) The docker image is pushed to dockerhub https://hub.docker.com/r/ripa1993/npm-cache-resource
